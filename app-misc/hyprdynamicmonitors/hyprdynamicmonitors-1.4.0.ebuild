...
EGO_SUM=(
	...
	"github.com/TheCreeper/go-notify v0.2.0/go.mod"
	...
	"github.com/charmbracelet/ultraviolet v0.0.0-20250911144506-c3463c079117/go.mod"
	...
	"github.com/charmbracelet/x/exp/teatest v0.0.0-20250929231137-76218bae042e"
	"github.com/charmbracelet/x/exp/teatest v0.0.0-20250929231137-76218bae042e/go.mod"
	...
	"github.com/charmbracelet/x/vt v0.0.0-20251016201629-54e687c87a08"
	"github.com/charmbracelet/x/vt v0.0.0-20251016201629-54e687c87a08/go.mod"
	...
	"github.com/spf13/cobra-cli v1.3.0/go.mod"
	...
	"github.com/t-yuki/gocover-cobertura v0.0.0-20180217150009-aaee18c8195c/go.mod"
...
DESCRIPTION="Autorandr+Arandr for Hyprland"
HOMEPAGE="https://github.com/fiffeek/hyprdynamicmonitors"

SRC_URI="https://github.com/fiffeek/${PN}/archive/refs/tags/v${PV}.tar.gz -> ${P}.tar.gz
	${EGO_SUM_SRC_URI}"
